...
import { getDocuments, updateDocuments } from "../../api/documents";
    ...
    <div>
      <Breadcrumbs
        data={[
          ...
          { path: router.location.pathname, name: "Edit Documents" },
        ]}
      />
      <div className="card">
        <h2 className="page-header"> Update Documents</h2>
      </div>
      <div className="row">
            ...
            <div className="card__body">
              ...
              <div className="d-flex mt-5">
                <button
                  ...
                  onClick={() => {
                    if (content) {
                      updateDocuments(content, router);
                    }
                  }}
                >
                  Update Documents
