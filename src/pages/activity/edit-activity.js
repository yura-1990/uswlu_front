...
import { updateActivity, getActivity } from "../../api/activity";
...
const ActivityEdit = () => {
  ...
  return (
    <div>
      <Breadcrumbs data={[{path: "/activity", name: "Activity "}, {path: router.location.pathname, name: "Edit Activity "}]} />
