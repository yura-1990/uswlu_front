...
import {addRectors} from "../../api/rectors";
...
const AddRector = () => {
    ...
    return (
        <div>
            <Breadcrumbs
                data={[{path: `/rectors`, name: "Rectors"}, {path: router.location.pathname, name: "Add Rector"}]}/>
            <div className="card">
                <h2 className="page-header">Add Rector</h2>
            </div>
            <div className="row">
                                ...
                                <div className="col-md-9">
                                    ...
                                    >
                                        ...
                                        <div className="mt-4 text-center">
                                            <button className="btn btn-primary">Add Rector</button>
                                        </div>
                                    </form>
                                </div>
