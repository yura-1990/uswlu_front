...
import { edit_departments, update_departments } from "../../api/departments";
    ...
    <div>
      <Breadcrumbs
        data={[
          ...
          { path: router.location.pathname, name: "Edit department" },
        ]}
      />
      <div className="card">
        <h2 className="page-header">Edit Departments</h2>
      </div>
      <div className="row">
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (data.description_uz) {
                        update_departments(data, router);
                      }
                    }}
                  >
                    Update Department
