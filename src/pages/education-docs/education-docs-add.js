...
import { addDocs } from "../../api/education-docs";
import Breadcrumbs from "../../components/breadcrumb";

const EducationDocsAdd = () => {
  ...
  return (
    <div>
      <Breadcrumbs data={[{ path: `/education-docs`, name: "Education Docs" }, {path: router.location.pathname, name: "Add Education Docs"}]} />

      <div className="card">
        <h2 className="page-header">Add Education docs</h2>
      </div>
          ...
          <div className="row">
            ...
            <div className="col-12 my-3">
              <button
                ...
                onClick={() => addDocs(content, router)}
              >
                Add Docs
              </button>
            </div>
...
export default EducationDocsAdd;
