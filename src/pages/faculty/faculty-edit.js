...
import { updateFaculty, getFaculty } from "../../api/faculty";
...
const FacultyEdit = () => {
  ...
  useEffect(() => {
    getFaculty(id, setData);
  }, [id]);
  return (
    <div>
      <Breadcrumbs
          data={[{path: `/faculty`, name: "Faculty"}, {path: router.location.pathname, name: "Edit faculty"}]}/>
      <div className="card">
        <h2 className="page-header">Update Faculty</h2>
      </div>
      <div className="row">
